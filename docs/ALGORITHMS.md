...
|---|---|---|---|---|
| Sentinel-2 L2A | B8A (`nir08`) | B12 (`swir22`) | 20 m | `(DN − 1000) / 10000` — BOA offset −1000; requires processing baseline ≥ 04.00 (asserted numerically, `S2_MIN_BASELINE = 4.0`; older products fail loud) |
...
| `S2_MIN_BASELINE` | 4.0 | [dnbr_create.py:60](../autoacquire/dnbr_create.py#L60) | Sentinel-2 processing baseline ≥ 04.00 asserted (the −1000 SR offset) |
