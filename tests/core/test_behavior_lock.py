...
Run:  pytest tests/core/test_behavior_lock.py -v     (or)   python tests/core/test_behavior_lock.py
"""
...
# ============================================================================
# Standalone runner (no pytest required): python tests/core/test_behavior_lock.py
# ============================================================================
