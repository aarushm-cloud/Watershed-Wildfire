...
Run:  pytest tests/core/test_ingest_seam.py -v   (or)   python tests/core/test_ingest_seam.py
"""
...
# ---------------------------------------------------------------------------
# Standalone runner (no pytest required): python tests/core/test_ingest_seam.py
# ---------------------------------------------------------------------------
