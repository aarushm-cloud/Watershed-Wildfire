"""The dNBR both-arms output layer (A34): ranking.csv + basins.geojson.
...
def _write_fake_dem(tmp_path, n=4):
    """Tiny synthetic GeoTIFF (mirrors tests/app/test_entrypoint.py::_write_synthetic_dem) -- adaptation:
