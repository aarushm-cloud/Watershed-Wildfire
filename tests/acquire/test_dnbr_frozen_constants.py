...
Run:  pytest tests/acquire/test_dnbr_frozen_constants.py -v   (or)   python tests/acquire/test_dnbr_frozen_constants.py
"""
...
# ---------------------------------------------------------------------------
# Standalone runner (no pytest required): python tests/acquire/test_dnbr_frozen_constants.py
# ---------------------------------------------------------------------------
